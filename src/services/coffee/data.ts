    ...
    'espresso': {
      'traditional': {
        ...
        steps: [
          ...
          {
            id: 2,
            instruction: `Não é estritamente necessário ter um WDT, mas tente distribuir o café uniformemente no porta-filtro. 
            WDT ajuda bastante.`,
      ...
      'ristretto': {
        ...
        name: 'Ristretto',
        imageUrl: '/images/espresso/ristretto.png',
        description: 'Uma versão mais forte e concentrada do espresso tradicional. A proporção é de 1:1, ou seja, para cada grama de café, você deve obter 1 grama de bebida no final.',
        ratio: 1,
        defaultDose: 18,
        tools: [
          {
